...
# What is the name of this app?
	define('APP_NAME', 'My Favorite Restaurant');  

# When email is sent out from the server, where should it come from?
# Ideally, this should match the domain name
	define('APP_EMAIL', 'kishleensaini@yahoo.com'); 
...
*/ 	
	define('SYSTEM_EMAIL', 'kishleensaini@gmail.com'); 

# Default DB name for this app
	define('DB_NAME', 'kishleen_p4_kishleen_biz'); 
...
# For extra security, you might want to set different salts than what the core uses
	define('PASSWORD_SALT', 'jkiloopiopppouytrppoiuy');
	define('TOKEN_SALT', 'kolpiyhkklllpvbhjkmsg');